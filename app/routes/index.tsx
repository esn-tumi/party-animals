    ...
    <main className="max-w-7xl m-auto px-2 md:px-8">
      <section className="my-2 md:my-8 rounded-[2.25rem] md:rounded-[3rem] overflow-hidden">
        <div className="pa-start">
          <div className="max-w-4xl px-8 pb-12 pt-32 md:px-12 md:pb-12 md:pt-64">
            ...
            <p className="mb-8 font-normal text-lg leading-normal md:text-xl md:leading-normal text-white text-opacity-80">
      ...
      <section className="bg-[#140033] my-2 md:my-8 rounded-[2.25rem] md:rounded-[3rem] overflow-hidden">
        <div className="max-w-4xl px-8 py-12 md:p-12">
          ...
          <p className="mb-8 font-normal text-lg leading-normal md:text-xl md:leading-normal text-violet-400">
        ...
        <div className="relative">
          ...
          <div className="relative bg-gradient-to-t from-[rgba(0,0,0,0.8)] bg-blend-multiply">
            <div className="max-w-4xl px-8 pb-12 pt-48 md:px-12 md:pb-12 md:pt-96">
              ...
              <p className="font-normal text-lg leading-normal md:text-xl md:leading-normal text-white text-opacity-80">
      ...
      <section className="my-2 md:my-8 w-full grid grid-flow-row grid-cols-1 gap-x-2 gap-y-2 md:gap-y-8 sm:grid-cols-2">
        <div className="bg-violet-200 rounded-md md:rounded-lg overflow-hidden">
          <div className="max-w-4xl p-8 md:p-12">
            ...
            <div className="mt-6 text-base font-normal leading-snug md:leading-snug">
              <p className="text-black text-opacity-60">
                ...
                of all activities and travels. It does not cover additional
                drinks and food that you may want to consume during the events.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl p-8 md:p-12">
            ...
            <div className="mt-6 text-base font-normal leading-snug md:leading-snug">
              <p className="text-white text-opacity-60">
                ...
                all activities and travels. It does not cover additional drinks
                and food that you may want to consume during the events.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-neutral-200 my-2 md:my-8 rounded-[2.25rem] md:rounded-[3rem] overflow-hidden">
        <div className="px-8 py-12 md:p-12">
          ...
          <p className="max-w-4xl mb-8 font-normal leading-normal text-xl md:leading-normal text-neutral-600">
          ...
          <div>
            ...
            <div className="px-4 py-3 mb-4 grid grid-flow-row grid-cols-1 sm:p-4 sm:grid-cols-2 sm:gap-4 rounded-xl bg-neutral-100">
              <strong className="self-center font-normal text-lg">
                Event Name
              </strong>
              <p className="self-center text-neutral-600 text-lg">
                Time: Description
              </p>
            </div>
            <div className="px-4 py-3 mb-4 grid grid-flow-row grid-cols-1 sm:p-4 sm:grid-cols-2 sm:gap-4 rounded-xl bg-neutral-100">
