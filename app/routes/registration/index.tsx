      ...
      <div className='flex flex-col items-center space-y-4 md:flex-row md:space-x-4'>
        ...
        <div>
          ...
          <Form action='/auth/auth0' method='post'>
            <button
              className='inline-block w-full rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 p-[2px] hover:text-white focus:outline-none focus:ring active:text-opacity-75'>
